# -*- coding: utf-8 -*-
"""kos_02 — model_02'in KENDI kosucusu. TEK BASINA DURUR.
...
`deneme2/kos.py`nin KOPYASI (uretici: elle, tek seferlik). Farklar:
    ...
    --model YOK       bu kosucu yalniz model_02'i baslatir; aile klasoru
                      ARANMAZ (paylasilan kos.py `deneme2/*/<ad>.py`
                      glob'u yapiyordu -- model_02 artik o aramaya
                      girmiyor bile)
    yol               yalniz KENDI klasoru sys.path'e girer

    python kos_02.py --ev <cikti koku> [--tohum 0] [--commit X]
...
KOK = os.path.dirname(os.path.abspath(__file__))       # deneme2/model_02/
MODEL = "model_02"
...
def main():
    ...
    # --model YOK: bu kosucu yalniz model_02'i baslatir.
