# -*- coding: utf-8 -*-
"""veri_02 — model_02'in KENDI verisi. TEK BASINA DURUR.
...
model_02'a aittir: `model_b` ailesi icin yapilan bir degisiklik buraya
GECMEZ.
...
Kopyanin DOGRULUGU goz karariyla degil, OLCUMLE tutuluyor:
    ...
    test_02.py    veri_02.kur(0) ile veri_okul4.kur(0) DERIN
...
# ======================================================================
# model_02'IN VERISI — iki adim + PARMAK IZI
# ======================================================================
...
if __name__ == "__main__":
    ...
    G = kur(0)
    z = zincirler(G)
    print("veri_02  varlik %d  olgu %d  zincir %d  |R| %d  phi TAVANI %.2f"
