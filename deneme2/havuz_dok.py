# -*- coding: utf-8 -*-
"""EGITIM HAVUZU DENETIMI -- satirlarin KENDISI dogru mu?

`veri_dok.py` BOLMELERI denetliyor (sizinti, kisayol, tek-kenar acigi).
Bu betik EGITIM SATIRLARINI denetliyor -- ozellikle model_b11'in yeni
BELGE satirlarini, cunku onlar veri_dok'un kapsaminda YOK.
"""
import sys
import collections
import numpy as np
...
_ap.add_argument("--model", default="model_b11")
_a = _ap.parse_args()
