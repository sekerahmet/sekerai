# -*- coding: utf-8 -*-
"""ek_17 -- TURKCE BOLME.  KOK AYRI TOKEN, EK AYRI TOKEN.
...
orada duzeltilmisti; `ek_17` onu birim duzeyinde geri getirmisti.
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  ek_17       kelime -> kok + ek    (Turkce morfolojisi)   <-- BU DOSYA
...
# =====================================================================
KOK = {
    # akrabalik ve roller -- veri_17.SEMA iliskilerinin kokleri
...
# --- ESKI ARAYUZ.  `birim_17` ve `olcme_14` bunlari cagiriyor. -------
