# -*- coding: utf-8 -*-
"""veri_mat17 -- DUZ MATEMATIK SINAVI: toplama, model_15'in verisiyle.

Kullanici, 23 Eylul: "model 15 de güzel bir veri var. Düz matematik sayılır
en kolay en güzel test o olabilir" ve "BOS ve EOS kullanabilriz dur a gerek
yok".

    <eos> 4 7 2 + 1 8 2 = 6 5 4 <eos>
    GENEL sinir token'i (veri_t17.SON), hikayelerdekiyle AYNI ad: basta BOS,
    sonda EOS (model_15'teki DUR'un yeri ve kimligi, 12).  Kayip YALNIZ
    cevabin rakamlarinda ve EOS'ta; soru rakamlari rastgele, hedef degil.
...
def olcut(eg, tu, aygit="cuda", en=2000):
    """train_17'nin bekledigi bicim: olcut(m, "eg"|"dg", tam) -> dict.
