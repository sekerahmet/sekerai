# -*- coding: utf-8 -*-
"""metin_17 — GRAFTAN DUZ TURKCE METIN. model_14'un veri katmani.
...
Unlu uyumu `veri_17`un tablolarindan gelir, burada YENIDEN HESAPLANMAZ.
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  metin_17    graf -> duz Turkce cumle   <-- BU DOSYA
