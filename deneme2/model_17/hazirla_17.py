...
GRAF dosyaya girmiyor: `veri_17.kur(0)` bir saniyede kuruluyor ve KENDI
iz kapisi var (3cd9a2575e47).  Dosyaya konan sey PAHALI olan ve kaymamasi
gereken sey: X.

  python hazirla_17.py --yaz
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  ayar_17     dugmeler
  hazirla_17  veriyi dosyaya yazar, Colab Drive'dan OKUR   <-- BU DOSYA
...
import ayar_17 as A          # noqa: E402
import jeton_17 as J         # noqa: E402
import taban_17 as T         # noqa: E402
import veri_17 as V          # noqa: E402

CIKTI = "korpus_17.pt"
CIKTI_BIRIM = "birim_17.pt"
...
def kur_birim(yaz=print):
    ...
    v = T.veri_kur(A.AYAR, yaz=lambda *a: None)
    b = BR.kur(A.AYAR, v, yaz=yaz, onbellek='birim_17.npz')
