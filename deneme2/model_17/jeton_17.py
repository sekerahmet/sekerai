# -*- coding: utf-8 -*-
"""jeton_17 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `veri_17`un allomorf tablolari metni URETMEYE devam
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  jeton_17    KARAKTER sozlugu + GIDIS-DONUS KAPISI   <-- BU DOSYA
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `korpus_17.havuz` dolduruyor: EGITIM TENSORUNUN izi.
