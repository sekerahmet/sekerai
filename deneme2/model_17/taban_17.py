# -*- coding: utf-8 -*-
"""taban_17 -- model_17'un VERI YOLU. `taban_11`den KOPYA.
...
egitim motoru. model_17 metne hic bakmiyor, yalniz grafa.
CLAUDE.md kural 7: cagrisiz kod tasinmaz.

KOPYANIN KAPISI IZLER:
    veri_17.IZ      == 3cd9a2575e47
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  taban_17    bolmeler (ezber_* / cikarim_*) + Ayar tanimi   <-- BU DOSYA
  ayar_17     dugmeler
