...
Kapinin kendisi `model_17._kapi`.
...
ZINCIRDEKI YERI:  birim_17 (akis) -> agirlik_17 (ofset dizisi) -> train_17
                  -> model_17._kapi
"""
import collections
import os
...
def varlik_tokenleri(d):
    """1.608 varligin token dizileri.  metin_17'nin kendi cevirisiyle."""
    import metin_17 as MT
    import olcme_17 as OL
...
if __name__ == "__main__":
    ...
    d = torch.load(os.environ.get("BIRIM_PT",
                                  "/content/drive/MyDrive/model_17/birim_17.pt"),
                   weights_only=False)
    denetle(d)
    agirlik(d)
