# -*- coding: utf-8 -*-
"""ayar_17 -- bu kolun BUTUN dugmeleri, her birinin gerekcesiyle.
...
IKI BOLUM, iki ayri sozlesme:
  ...
  MODEL   BU DOSYADA YOK.  model_17'nin mimarisi model_15'ten geliyor
          ve butun ayarlari model_17.py'nin basinda duruyor.
...
AYAR = Ayar(
    ...
    #                      satir satir kuruluyor (`birim_17.belgeler`).
    #                      Bu deger yalniz IKI yerde kaldi:
    #                        - hazirla_17.kur()  KARAKTER korpusu
    #                        - korpus_17.sayfalar() TETIKLENMIS dalda
