...
YUZEY `metin_17.sinav_yuzeyi`den gelir, ELLE DIZILMEZ -- sinavin yuzeyi
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  olcme_17    olcu: soru soruldu, cevap dogru mu   <-- BU DOSYA
"""
import torch
...
def _kodlayici(d):
    ...
    her kelime ek_17 ile kok+eke ayrilir.  Bir kelime sozlukte yoksa
    sinav SESSIZCE kosmaz -- denetim_17 kapi 5 bunu sinar.
...
def olcut(d, aygit="cuda", en=2000, tam_en=10 ** 9):
    """train_17'nin bekledigi bicim:  olcut(m, "ezber"|"cikarim", tam=False)"""
