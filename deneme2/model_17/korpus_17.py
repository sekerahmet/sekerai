# -*- coding: utf-8 -*-
"""korpus_17 — CUMLELERDEN BELGE, BELGELERDEN PAKET. model_09'un havuzu.
...
(model BIRIM goruyor -- karakter yalnizca ara adim ve kapi)
  ...
  korpus_17   cumle -> belge -> paketlenmis akis   <-- BU DOSYA
...
import jeton_17 as J
import metin_17 as MT
import veri_17 as V
...
def reddetme_belgeleri(v, G, n, tohum=0, grup=6, bolme=None, yaz=print):
    ...
    Ayrinti `veri_17.IMKANSIZ` basindaki notta.
...
def _havuz_kapisi(X, dilim, S, t_len, yaz=print):
    ...
    yaz(f"  KORPUS IZI {S.korpus_izi}   -- tensorun kendisi. `metin_17` ya "
        f"da `korpus_17` degisirse bu deger degisir, `ayar` DEGISMEZ.")
