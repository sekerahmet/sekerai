# -*- coding: utf-8 -*-
"""jeton_14 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `veri_14`un allomorf tablolari metni URETMEYE devam
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `korpus_14.havuz` dolduruyor: EGITIM TENSORUNUN izi.
