# -*- coding: utf-8 -*-
"""korpus_14 — CUMLELERDEN BELGE, BELGELERDEN PAKET. model_09'un havuzu.
...
def reddetme_belgeleri(v, G, n, tohum=0, grup=6, bolme=None, yaz=print):
    ...
    Ayrinti `veri_14.IMKANSIZ` basindaki notta.
...
def _havuz_kapisi(X, dilim, S, t_len, yaz=print):
    ...
    yaz(f"  KORPUS IZI {S.korpus_izi}   -- tensorun kendisi. `metin_14` ya "
        f"da `korpus_14` degisirse bu deger degisir, `ayar` DEGISMEZ.")
