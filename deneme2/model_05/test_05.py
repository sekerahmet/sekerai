# -*- coding: utf-8 -*-
"""model_05 KILIDI -- "her seyden bagimsiz" iddiasi SINANIR.
...
# --- 0) BAGIMSIZLIK ------------------------------------------------------
print("=== 0) BAGIMSIZLIK: model_05/ disariya BAGLI MI ===")
...
import model_05 as S                                         # noqa: E402
...
import asama1_05 as A1                                      # noqa: E402
_lst = v.comp[:8]
...
import veri_05 as V00                                        # noqa: E402

ok(A.veri_ad == "veri_05", "model_05 KENDI veri modulunu okur", A.veri_ad)
_G0 = V00.kur(0)
...
from ayar_05 import GOREV_ALAN                               # noqa: E402
