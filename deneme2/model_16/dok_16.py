"""dok_16 -- modelin gordugu HER SEYI goz ile okunur dosyaya dok.
...
"makul" durabilir; metin duramaz.
    ...
    python dok_16.py [klasor]        varsayilan: model_16/veri
...
uretim dokumleri).  model_16'nin olcusu bastan yazildi ve o sinifllar
...
import ayar_16 as AY      # noqa: E402
import birim_16 as BR     # noqa: E402
import ek_16 as EK        # noqa: E402
import taban_16 as MT     # noqa: E402
import veri_16 as V       # noqa: E402

ONBELLEK = "birim_16.npz"
...
def main():
    ...
    with ac(kls, "01_token_listesi.txt") as f:
        ...
        f.write(f"Korpustaki {len(b.bolme):,} kelimenin {len(b.bolme):,}'u "
                ...
                "cozuluyor; cozulemeyen YOK (`ek_16.denetle` her "
                "kurulumda sinar).\n\n")
