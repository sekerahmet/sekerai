# -*- coding: utf-8 -*-
"""jeton_12 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `veri_12`un allomorf tablolari metni URETMEYE devam
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `korpus_12.havuz` dolduruyor: EGITIM TENSORUNUN izi.
