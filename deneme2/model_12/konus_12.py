# -*- coding: utf-8 -*-
"""konus_12 — model_12 ile DUZ KONUSMA. Sablon YOK, kisit YOK.

    python konus_12.py [klasor] [--adim N | --pencere 5] [--panel]
    python konus_12.py --soru "Ahmet Aydin'in kardesi kimdir?"
...
!! BU BIR OLCU DEGIL. Hukum `pencere_12` ile verilir. Buradaki her sey
...
KLASOR = os.path.join("G:" + os.sep, "Drive'im", "model_12", "t0")
...
def yukle(klasor: str, adim=None, pencere=0):
    ...
    yuklenir; hukum okumasi (`pencere_12`) da bunu kullanir, yani
    ...
    geciyor ve EGITILENDEN BASKA bir korpus kuruyordu (test_12 §0b)."""
...
def sor(net, S, metin: str, n=120, nokta_durur=True) -> str:
    ...
    !! Uretim `olcme_12.uret` ile, yani SINAVIN kullandigi kodun
...
# ======================= NITELIK PANELI ==================================
# Onkayit model_12.md §4: DOGRULUK / DURUSTLUK / TUTARLILIK / AKICILIK.
...
def panel(net, S, G, uzun=200):
    ...
    print(" (Hukum `pencere_12` + `durustluk_12` ile verilir.)")
    print("=" * 78)
    son = None
    sayac = {}
...
def main():
    ...
    print(f"model_12  t{ayar.tohum}   {hangi}")
