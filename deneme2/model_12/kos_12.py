# -*- coding: utf-8 -*-
"""kos_12 — BU KOLUN KENDI kosucusu. TEK BASINA DURUR.
...
`deneme2/kos.py`nin KOPYASI (uretici: elle, tek seferlik). Farklar:
    ...
    python kos_12.py --ev <cikti koku> [--tohum 0] [--commit X]
...
KOK = os.path.dirname(os.path.abspath(__file__))       # deneme2/model_12/
MODEL = "model_12"
...
def main():
    ...
    # mi tutuldugunu. `GPU_HAVUZ` model_09'de YOK (taban_12.egit'teki
