# -*- coding: utf-8 -*-
"""olcme_12 — SINAV: serbest uretim, tam eslesme.
...
def sorular(v, G, lst, hop):
    ...
    for z in lst:
        if hop == 1:
            ...
            # model_12'da 5 degil 4 parametre aliyor -- asagidaki
...
# HIC gecmez (`korpus_12.reddetme_bolme`). Gordugunu reddetmek EZBER,
...
def ret_mi(c: str) -> bool:
    ...
    `metin_12.YOK_VARLIK` / `YOK_ILISKI` kaliplarindan geliyorlar ve
    `test_12` §3i ikisini de GERCEK korpusa karsi siniyor -- uretilen
...
def biyografi_sinavi(S, v, G, ents, t_len=640):
    ...
    for i, e in enumerate(ents):
        ...
        # model_12'da `cumle` 4 parametre aliyor ve bildirim sayisi
