# -*- coding: utf-8 -*-
"""tani_12 — ARIZA SEKLI: model YANLIS cevap verirken NE diyor?

    python tani_12.py <kosu klasoru> [--adim N]
...
def main():
    ...
    print(f"=== tani_12  {ayar.ad} t{ayar.tohum}  adim {adim} ===")
    ...
    if a.biyografi:
        ...
        if _cok:
            # !! `KOR.biyografiler` ARTIK YOK -- model_12'da `sayfalar`
            # oldu. Bu satir kopyadan geldi ve `--biyografi`nin
            # VARSAYILAN yolu oldugu icin `tani_12` HER KOSUDA
