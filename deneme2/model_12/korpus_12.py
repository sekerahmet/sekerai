# -*- coding: utf-8 -*-
"""korpus_12 — CUMLELERDEN BELGE, BELGELERDEN PAKET. model_09'un havuzu.
...
def reddetme_belgeleri(v, G, n, tohum=0, grup=6, bolme=None, yaz=print):
    ...
    Ayrinti `veri_12.IMKANSIZ` basindaki notta.
...
def yasak_ciftler(v):
    ...
    yalniz kendi sahibinin olgularini soyluyordu. model_12'da sayfa
...
def _havuz_kapisi(X, dilim, S, t_len, yaz=print):
    ...
    yaz(f"  KORPUS IZI {S.korpus_izi}   -- tensorun kendisi. `metin_12` ya "
        f"da `korpus_12` degisirse bu deger degisir, `ayar` DEGISMEZ.")
