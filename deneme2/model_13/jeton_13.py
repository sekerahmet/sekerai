# -*- coding: utf-8 -*-
"""jeton_13 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `veri_13`un allomorf tablolari metni URETMEYE devam
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `korpus_13.havuz` dolduruyor: EGITIM TENSORUNUN izi.
