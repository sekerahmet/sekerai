# -*- coding: utf-8 -*-
"""ayar_06 — model_05'in KENDI ayari. TEK BASINA DURUR.
...
from taban_06 import Ayar                                    # noqa: E402
...
AYAR = Ayar(
    ...
    veri_ad="veri_06",   # KENDI veri modulu -- ve BU KOLUN DUGMESI.
    ...
    bicim=3,             # UC TURKCE SIRA (soru bicimi YOK -- model_06)
...
assert AYAR.veri_ad == "veri_06", "model_05 KENDI veri modulunu okur"
