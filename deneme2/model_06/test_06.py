# -*- coding: utf-8 -*-
"""model_06 KILIDI -- "her seyden bagimsiz" iddiasi SINANIR.
...
# --- 0) BAGIMSIZLIK ------------------------------------------------------
print("=== 0) BAGIMSIZLIK: model_06/ disariya BAGLI MI ===")
...
import model_06 as S                                         # noqa: E402
...
import asama1_06 as A1                                      # noqa: E402
_lst = v.comp[:8]
...
import veri_06 as V00                                        # noqa: E402

ok(A.veri_ad == "veri_06", "model_05 KENDI veri modulunu okur", A.veri_ad)
_G0 = V00.kur(0)
...
for ad in ("veri_06", "taban_06", "ayar_06", "pencere_06", "tani_06",
           "asama1_06", "sor_06", "kos_06", "konus_06"):
    _r2 = subprocess.run(
        [sys.executable, "-c",
