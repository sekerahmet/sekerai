# -*- coding: utf-8 -*-
"""graf_10 — BU KOLUN KENDI GRAF TUTARLILIK DENETIMI. TEK BASINA DURUR.
...
tanir. Dokum `model_10/veri/model_10/` altina gider (depoya girmez).
...
from ayar_10 import AYAR     # noqa: E402
...
# arac KeyError verdi (17 Eylul) -- liste artik veri_10'in yaninda.
...
print(f"      onlardan YALNIZ BIRINI gosteriyor. veri_10'te bu SECIM")
...
# r3 yerine kullaniyordu. veri_10'te (annesi,cocugu)->kardesi var:
