# -*- coding: utf-8 -*-
"""konus_10 — model_10 ile DUZ KONUSMA. Sablon YOK, kisit YOK.

    python konus_10.py [klasor] [--adim N | --pencere 5] [--panel]
    python konus_10.py --soru "Ahmet Aydin'in kardesi kimdir?"
...
!! BU BIR OLCU DEGIL. Hukum `pencere_10` ile verilir. Buradaki her sey
...
KLASOR = os.path.join("G:" + os.sep, "Drive'im", "model_10", "t0")
...
def yukle(klasor: str, adim=None, pencere=0):
    ...
    yuklenir; hukum okumasi (`pencere_10`) da bunu kullanir, yani
    ...
    geciyor ve EGITILENDEN BASKA bir korpus kuruyordu (test_10 §0b)."""
...
def sor(net, S, metin: str, n=120, nokta_durur=True) -> str:
    ...
    !! Uretim `olcme_10.uret` ile, yani SINAVIN kullandigi kodun
...
# ======================= NITELIK PANELI ==================================
# Onkayit model_10.md §4: DOGRULUK / DURUSTLUK / TUTARLILIK / AKICILIK.
...
def panel(net, S, G, uzun=200):
    ...
    print(" (Hukum `pencere_10` + `durustluk_10` ile verilir.)")
    print("=" * 78)
    son = None
    sayac = {}
...
def main():
    ...
    print(f"model_10  t{ayar.tohum}   {hangi}")
