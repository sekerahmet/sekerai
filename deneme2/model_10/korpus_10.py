# -*- coding: utf-8 -*-
"""korpus_10 — CUMLELERDEN BELGE, BELGELERDEN PAKET. model_09'un havuzu.
...
def reddetme_belgeleri(v, G, n, tohum=0, grup=6, bolme=None, yaz=print):
    ...
    Ayrinti `veri_10.IMKANSIZ` basindaki notta.
...
def yasak_ciftler(v):
    ...
    yalniz kendi sahibinin olgularini soyluyordu. model_10'da sayfa
...
def _havuz_kapisi(X, dilim, S, t_len, yaz=print):
    ...
    yaz(f"  KORPUS IZI {S.korpus_izi}   -- tensorun kendisi. `metin_10` ya "
        f"da `korpus_10` degisirse bu deger degisir, `ayar` DEGISMEZ.")
