# -*- coding: utf-8 -*-
"""jeton_10 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `veri_10`un allomorf tablolari metni URETMEYE devam
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `korpus_10.havuz` dolduruyor: EGITIM TENSORUNUN izi.
