# -*- coding: utf-8 -*-
"""ayar_10 — BU KOLUN KENDI ayari. TEK BASINA DURUR.
...
IKI GRUP, IKI GEREKCE
  ...
  GOREV alanlari    -> model_b15'in gordugu sinavla AYNI KALMASI
                       ...
                       ve ikisi de BU KOLUN TANIMI:
                         ...
                         ek_kip   "tr" -> "tr2"
                       `test_10.py` bunlari BILDIRILMIS AYRISMA diye
...
from taban_10 import Ayar                                    # noqa: E402

# Sinavin AYNI kalmasi GEREKEN alanlari. `test_10.py` bunlari model_b15
...
# Dolayisiyla `test_09` artik "veri_10 == veri_okul4" demiyor;
# `veri_10`in KENDI IDDIALARINI siniyor (sema, soy agaci, zincir
...
AYAR = Ayar(
    ...
    veri_ad="veri_10",   # KENDI veri modulu -- ve BU KOLUN DUGMESI.
    ...
    #
    #   bicim=3       -> metin_10.BICIM, DORT yuzey, cumle basina RASTGELE
    ...
    #   ident_frac    -> kimlik BELGESI (korpus_10.kimlik_belgeleri)
    #
    ...
    # SURDURMEDIR: `kos_10.py --adim 40000 --surdur`.
...
# KORPUS JETONU: OLCULDU, elle yazilmadi. `korpus_10` degisirse bu
...
assert AYAR.veri_ad == "veri_10", "BU KOL KENDI veri modulunu okur"
