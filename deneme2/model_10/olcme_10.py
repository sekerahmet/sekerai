# -*- coding: utf-8 -*-
"""olcme_10 — SINAV: serbest uretim, tam eslesme.
...
def sorular(v, G, lst, hop):
    ...
    for z in lst:
        if hop == 1:
            ...
            # model_10'da 5 degil 4 parametre aliyor -- asagidaki
...
# HIC gecmez (`korpus_10.reddetme_bolme`). Gordugunu reddetmek EZBER,
...
def ret_mi(c: str) -> bool:
    ...
    `metin_10.YOK_VARLIK` / `YOK_ILISKI` kaliplarindan geliyorlar ve
    `test_10` §3i ikisini de GERCEK korpusa karsi siniyor -- uretilen
