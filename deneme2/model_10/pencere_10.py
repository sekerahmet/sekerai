# -*- coding: utf-8 -*-
"""pencere_10 — BU KOLUN KENDI BIRINCIL OKUMASI. TEK BASINA DURUR.
...
GECMEZ; `test_10.py` ikisinin AYNI SEYI olctugunu her kosuda siniyor.
"""
...
def ayar_oku(klasor: str) -> M.Ayar:
    ...
    # Tablo `taban_10.ESKI_VARSAYILAN` -- TEK yerde durur, `surdurme_oku`
...
def main():
    ...
    # OLCME SETI PARMAK IZI -- taban_10.olcme_izi()'nden, KOPYA DEGIL.
    iz = M.olcme_izi(L)
