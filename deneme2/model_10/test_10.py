...
# §0c 'cagrilan nitelik VAR MI' diye bakiyor. `havuz_10` soyle bir
# satir tasiyordu:
...
_ice, _tsn = [], []
for _f in sorted(glob.glob(os.path.join(_B, '*_10.py'))):
...
# !! BU KAPI BIR OLCUM YALANINDAN DOGDU (19 Eylul, model_10 kosusundan
...
# yani `v.tr2`nin hepsi yaziliyordu. model_10'da zincir %20 ve
