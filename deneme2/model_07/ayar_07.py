# -*- coding: utf-8 -*-
"""ayar_07 — model_05'in KENDI ayari. TEK BASINA DURUR.
...
from taban_07 import Ayar                                    # noqa: E402
...
AYAR = Ayar(
    ...
    veri_ad="veri_07",   # KENDI veri modulu -- ve BU KOLUN DUGMESI.
...
assert AYAR.veri_ad == "veri_07", "model_05 KENDI veri modulunu okur"
