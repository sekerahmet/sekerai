# -*- coding: utf-8 -*-
"""analiz_07 — model_05'in KENDI VERI DOKUMU + SAGLIK DENETIMI. TEK BASINA DURUR.
...
class Dok:
    ...
    def jeton_ad(self, i):
        ...
        if getattr(v, "ek0", 0) and i >= v.ek0:
            ...
            # BOSLUK DOLDURMA jetonlari sozlugun EN SONUNDA (model_07).
...
def yaz_tokenlar(d, yol):
    ...
    with open(yol, "w", encoding="utf-8") as f:
        ...
        f.write("=" * 74 + "\n")
        # !! SAYIM DUZELTILDI (model_07). Onceden EK jetonlari da
...
def main():
    ...
    ap.set_defaults(model="model_07")
