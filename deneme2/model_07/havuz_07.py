# -*- coding: utf-8 -*-
"""havuz_07 — model_05'in KENDI EGITIM HAVUZU DENETIMI. TEK BASINA DURUR.
...
from ayar_07 import AYAR     # noqa: E402
...
for i in np.intersect1d(np.concatenate([i1[:6000], i2[:6000]]), _ol):
    ...
    # dilim `[:P[0]]` o konumu DISARIDA birakiyordu ve model_07'da orasi
