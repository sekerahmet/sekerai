# -*- coding: utf-8 -*-
"""konus_07 — model_07 ile DUZ KONUSMA. Sablon YOK, denetim YOK.
...
`sor_07.py` NEDEN YETMEDI -- ikisi AYRI SEY olcuyor:

    sor_07    soruyu COZUMLER (varlik + iliski), diziyi `kodla_1hop` ile
    ...
    konus_07  yazdigin cumleyi JETONLAYIP modele verir, gerisini MODEL
...
import pencere_07 as P                                        # noqa: E402
...
KLASOR = os.path.join("G:" + os.sep, "Drive'ım", "model_07", "t0")
...
class Sozluk:
    ...
    def __init__(self, v, VM):
        ...
        assert v.paylasilan, "konus_07 PAYLASILAN sozluk bekler"
        self.kel = {}
    ...
    def jetonla(self, metin):
        ...
        #   ,  devrik cumlede OGE SINIRI (model_07'nin yeni jetonu).
    ...
    def _bul(self, f):
        ...
        #   "annesidir"  ->  annesi + dir   (model_07 bicim 2: YUKLEM
...
def devam(v, net, jet, ornekle=False, isi=1.0, tohum=None):
    ...
    okur -- sor_07'te bunun neden onemli oldugu olculmustu.
    """
...
def dene(D, S, n=300):
    """JETONLAYICI SINAMASI -- `python konus_07.py --dene`.
    ...
    Kilit testine (`test_07.py`) KONMADI: o test kosudan once calisan
...
def main():
    ...
    assert (D.v.vocab, D.v.n_ent, D.v.ek0) == (v.vocab, v.n_ent, v.ek0), (
        "depodaki model_07.AYAR ile KOSUNUN ayari ayristi -- sozluk tutmuyor")
    D.v = v                      # kosunun kendi verisi okunsun
    S = Sozluk(v, D.VM)

    print(f"model_07 t{ayar.tohum}   anlik goruntu "
