# -*- coding: utf-8 -*-
"""dokum_09 — model_09 korpusu, OKUNABILIR metin dosyalari.

    python dokum_09.py [--kopya 5] [--tlen 512] [--ornek 60]
...
import jeton_09 as J                                          # noqa: E402
import korpus_09 as K                                         # noqa: E402
import metin_09 as MT                                         # noqa: E402
import model_09 as MM                                         # noqa: E402
...
def main():
    ...
    a = ap.parse_args()
    kl = os.path.join(_K, "veri", "model_09")
    ...
    with io.open(os.path.join(kl, "00_ICINDEKILER.txt"), "w",
        ...
        f.write("model_09 — KORPUS" + NL + "=" * 72 + NL + NL)
