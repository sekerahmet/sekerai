# -*- coding: utf-8 -*-
"""graf_09 — BU KOLUN KENDI GRAF TUTARLILIK DENETIMI. TEK BASINA DURUR.
...
tanir. Dokum `model_09/veri/model_09/` altina gider (depoya girmez).
...
from ayar_09 import AYAR     # noqa: E402
...
# arac KeyError verdi (17 Eylul) -- liste artik veri_09'in yaninda.
...
print(f"      onlardan YALNIZ BIRINI gosteriyor. veri_09'te bu SECIM")
...
# r3 yerine kullaniyordu. veri_09'te (annesi,cocugu)->kardesi var:
