# -*- coding: utf-8 -*-
"""veri_09 — BU KOLUN KENDI verisi. TEK BASINA DURUR.
...
# (taban_09.py 808 ve 843 bunu boyle kuruyor, veri_04 de boyleydi.)
#
...
def ek_secim(G):
    ...
    indeks olarak verir. `taban_09.veri_kur` bunu okur.
