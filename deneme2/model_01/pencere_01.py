# -*- coding: utf-8 -*-
"""pencere_01 — model_01'in KENDI BIRINCIL OKUMASI. TEK BASINA DURUR.
...
GECMEZ; `test_01.py` ikisinin AYNI SEYI olctugunu her kosuda siniyor.
"""
...
from model_01 import ModelSade                                # noqa: E402

# model_01'in TEK modeli var; kanca yok, dogrudan yazili.
...
def ayar_oku(klasor: str) -> M.Ayar:
    ...
    # Tablo `taban_01.ESKI_VARSAYILAN` -- TEK yerde durur, `surdurme_oku`
...
def main():
    ...
    kod = {k: (M.kodla_1hop(veri, L[k]) if k == "one" else M.kodla_2hop(veri, L[k]))
           for k in L if L[k]}
    # OLCME SETI PARMAK IZI -- taban_01.olcme_izi()'nden, KOPYA DEGIL.
    iz = M.olcme_izi(L)
