# -*- coding: utf-8 -*-
"""veri_01 — model_01'in KENDI verisi. TEK BASINA DURUR.
...
model_01'a aittir: `model_b` ailesi icin yapilan bir degisiklik buraya
GECMEZ.
...
Kopyanin DOGRULUGU goz karariyla degil, OLCUMLE tutuluyor:
    ...
    test_01.py    veri_01.kur(0) ile veri_okul4.kur(0) DERIN
...
# ======================================================================
# model_01'IN VERISI — iki adim + PARMAK IZI
# ======================================================================
...
if __name__ == "__main__":
    ...
    G = kur(0)
    z = zincirler(G)
    print("veri_01  varlik %d  olgu %d  zincir %d  |R| %d  phi TAVANI %.2f"
