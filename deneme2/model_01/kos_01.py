# -*- coding: utf-8 -*-
"""kos_01 — model_01'in KENDI kosucusu. TEK BASINA DURUR.
...
`deneme2/kos.py`nin KOPYASI (uretici: elle, tek seferlik). Farklar:
    ...
    --model YOK       bu kosucu yalniz model_01'i baslatir; aile klasoru
                      ARANMAZ (paylasilan kos.py `deneme2/*/<ad>.py`
                      glob'u yapiyordu -- model_01 artik o aramaya
                      girmiyor bile)
    yol               yalniz KENDI klasoru sys.path'e girer

    python kos_01.py --ev <cikti koku> [--tohum 0] [--commit X]
...
KOK = os.path.dirname(os.path.abspath(__file__))       # deneme2/model_01/
MODEL = "model_01"
...
def main():
    ...
    # --model YOK: bu kosucu yalniz model_01'i baslatir.
