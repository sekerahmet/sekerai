# -*- coding: utf-8 -*-
"""analiz_01 — model_01'in KENDI VERI DOKUMU + SAGLIK DENETIMI. TEK BASINA DURUR.

Kullanici karari, 16 Eylul 2026: *"bunlarin hepsi model_01 folderi
altinda olmali. model_01 diger hicbir model ile ayni seyi kullanmamali.
Analiz icinde analiz_01 kullanalim mesela, digerleri icin de."*

`veri_dok.py`nin KOPYASI (uretici: scratchpad/kur_analiz00.py). Iki fark:
motor `taban_01`, ve `--model` secenegi YOK -- bu arac yalniz model_01'i
tanir. Dokum `model_01/veri/model_01/` altina gider (depoya girmez).

    python analiz_01.py [--tam] [--klasor <yol>]
"""
...
class Dok:
    ...
    def jeton_ad(self, i):
        ...
        # bu arac `ek_kip` gelen HER kolda (model_b15, model_01) coker,
...
def main():
    ...
    # `--model` YOK: bu arac yalniz model_01'i tanir.
    ap.set_defaults(model="model_01")
