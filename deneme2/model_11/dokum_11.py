# -*- coding: utf-8 -*-
"""dokum_11 — model_11 korpusu, OKUNABILIR metin dosyalari.

    python dokum_11.py [--kopya 5] [--tlen 512] [--ornek 60]
...
import jeton_11 as J                                          # noqa: E402
import korpus_11 as K                                         # noqa: E402
import metin_11 as MT                                         # noqa: E402
import model_11 as MM                                         # noqa: E402
...
def main():
    ...
    a = ap.parse_args()
    kl = os.path.join(_K, "veri", "model_11")
    ...
    with io.open(os.path.join(kl, "00_ICINDEKILER.txt"), "w",
        ...
        f.write("model_11 — KORPUS" + NL + "=" * 72 + NL + NL)
