# -*- coding: utf-8 -*-
"""jeton_11 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `veri_11`un allomorf tablolari metni URETMEYE devam
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `korpus_11.havuz` dolduruyor: EGITIM TENSORUNUN izi.
