# -*- coding: utf-8 -*-
"""graf_11 — BU KOLUN KENDI GRAF TUTARLILIK DENETIMI. TEK BASINA DURUR.
...
tanir. Dokum `model_11/veri/model_11/` altina gider (depoya girmez).
...
# arac KeyError verdi (17 Eylul) -- liste artik veri_11'in yaninda.
...
print(f"      onlardan YALNIZ BIRINI gosteriyor. veri_11'te bu SECIM")
...
# r3 yerine kullaniyordu. veri_11'te (annesi,cocugu)->kardesi var:
