# -*- coding: utf-8 -*-
"""ayar_11 — BU KOLUN KENDI ayari. TEK BASINA DURUR.
...
from taban_11 import Ayar                                    # noqa: E402
...
# `veri_11`in KENDI IDDIALARINI siniyor (sema, soy agaci, zincir
...
AYAR = Ayar(
    ...
    veri_ad="veri_11",   # KENDI veri modulu -- ve BU KOLUN DUGMESI.
...
assert AYAR.veri_ad == "veri_11", "BU KOL KENDI veri modulunu okur"
