# -*- coding: utf-8 -*-
"""dil_11 — DIL ALANI: modelin EK KURALINI ogrenip ogrenmedigi.

    python dil_11.py <kosu klasoru> [--adim N] [--n 300]
...
# icinde aktarilir. Sebep: `taban_11` bu dosyayi ice aktariyor (WUG
...
def main():
    ...
    if a.unlu:
        ...
        net.eval()
        print(f"=== dil_11  --unlu   {ayar.ad} t{ayar.tohum}  "
              f"adim {_ad} ===")
    ...
    print(f"=== dil_11  EK UYUMU / asgari cift   {ayar.ad} t{ayar.tohum} ===")
