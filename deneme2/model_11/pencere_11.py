# -*- coding: utf-8 -*-
"""pencere_11 — BU KOLUN KENDI BIRINCIL OKUMASI. TEK BASINA DURUR.
...
GECMEZ; `test_11.py` ikisinin AYNI SEYI olctugunu her kosuda siniyor.
"""
...
def ayar_oku(klasor: str) -> M.Ayar:
    ...
    # Tablo `taban_11.ESKI_VARSAYILAN` -- TEK yerde durur, `surdurme_oku`
...
def main():
    ...
    _X, S = M.egitim_havuzu(ayar, veri, yaz=lambda *x, **y: None)
    ...
    # OLCME SETI PARMAK IZI -- taban_11.olcme_izi()'nden, KOPYA DEGIL.
    iz = M.olcme_izi(L)
