# -*- coding: utf-8 -*-
"""tr_chars_19 — KARAKTER TOKENIZER. model_09'un sozlugu.
...
ogrenmek zorunda. `tr_graph_19`un allomorf tablolari metni URETMEYE devam
...
model_16'nin jeton_16.py'sinden tasindi, icerik birebir (izler data_tr_19.REF_* ile sinanir).
...
class Sozluk:
    ...
    def __init__(self, metin: str):
        ...
        # `tr_corpus_19.havuz` dolduruyor: EGITIM TENSORUNUN izi.
