# -*- coding: utf-8 -*-
"""tr_splits_19 -- model_16'un VERI YOLU. `taban_11`den KOPYA.
...
KOPYANIN KAPISI IZLER:
    tr_graph_19.IZ      == 3cd9a2575e47
    olcme_izi(L)    == 44e6262e37f3

model_16'nin taban_16.py'sinden tasindi, icerik birebir (izler data_tr_19.REF_* ile sinanir).
