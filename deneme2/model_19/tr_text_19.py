# -*- coding: utf-8 -*-
"""tr_text_19 — GRAFTAN DUZ TURKCE METIN. model_14'un veri katmani.
...
Unlu uyumu `tr_graph_19`un tablolarindan gelir, burada YENIDEN HESAPLANMAZ.

model_16'nin metin_16.py'sinden tasindi, icerik birebir (izler data_tr_19.REF_* ile sinanir).
...
# model_09 -> model_14 kopyasinda tasinmadi ve bunu KOPYA KAPISI
# gosterdi (kullanici: *"diff calistirip bakmadin mi?"*). Dusmesi
# model_14'da model_09'dakinden DAHA pahali olurdu: orada 4 bicim
