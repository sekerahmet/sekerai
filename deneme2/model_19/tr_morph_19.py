# -*- coding: utf-8 -*-
"""tr_morph_19 -- TURKCE BOLME.  KOK AYRI TOKEN, EK AYRI TOKEN.  (model_16/ek_16.py, icerik birebir)
...
ZINCIRDEKI YERI (model_19):  tr_graph_19 -> tr_text_19 -> tr_corpus_19 -> data_tr_19 (parca, MorphTokenizer)
  tr_morph_19   kelime -> kok + ek    (Turkce morfolojisi)   <-- BU DOSYA
data_tr_19.MorphTokenizer kokun YUZEY bicimini (buyuk harf, 'cocug') ve kesme isaretini ayri token tutar:
metin birebir geri cozulur.
"""
