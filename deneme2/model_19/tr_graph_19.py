# -*- coding: utf-8 -*-
"""tr_graph_19 — BU KOLUN KENDI verisi. TEK BASINA DURUR.
...
model_16'nin veri_16.py'sinden tasindi, icerik birebir (izler data_tr_19.REF_* ile sinanir).
...
def kur(tohum=0):
    ...
    if tohum == 0 and IZ:
        _iz = graf_izi(G)
        assert _iz == IZ, (
            f"tr_graph_19: graf DEGISTI  {IZ} -> {_iz}\n"
