# -*- coding: utf-8 -*-
"""pencere_00 — model_00'in KENDI BIRINCIL OKUMASI. TEK BASINA DURUR.
...
GECMEZ; `test_00.py` ikisinin AYNI SEYI olctugunu her kosuda siniyor.
"""
...
# model_00'in TEK modeli var; kanca yok, dogrudan yazili.
...
def ayar_oku(klasor: str) -> M.Ayar:
    ...
    # Tablo `taban_00.ESKI_VARSAYILAN` -- TEK yerde durur, `surdurme_oku`
...
def main():
    ...
    kod = {k: (M.kodla_1hop(veri, L[k]) if k == "one" else M.kodla_2hop(veri, L[k]))
           for k in L if L[k]}
    # OLCME SETI PARMAK IZI -- taban_00.olcme_izi()'nden, KOPYA DEGIL.
    iz = M.olcme_izi(L)
