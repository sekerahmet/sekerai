# -*- coding: utf-8 -*-
"""kos_00 — model_00'in KENDI kosucusu. TEK BASINA DURUR.
...
`deneme2/kos.py`nin KOPYASI (uretici: elle, tek seferlik). Farklar:
    ...
    --model YOK       bu kosucu yalniz model_00'i baslatir; aile klasoru
                      ARANMAZ (paylasilan kos.py `deneme2/*/<ad>.py`
                      glob'u yapiyordu -- model_00 artik o aramaya
                      girmiyor bile)
    yol               yalniz KENDI klasoru sys.path'e girer

    python kos_00.py --ev <cikti koku> [--tohum 0] [--commit X]
...
KOK = os.path.dirname(os.path.abspath(__file__))       # deneme2/model_00/
MODEL = "model_00"
...
def main():
    ...
    # --model YOK: bu kosucu yalniz model_00'i baslatir.
