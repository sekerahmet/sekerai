# -*- coding: utf-8 -*-
"""veri_00 — model_00'in KENDI verisi. TEK BASINA DURUR.
...
model_00'a aittir: `model_b` ailesi icin yapilan bir degisiklik buraya
GECMEZ.
...
Kopyanin DOGRULUGU goz karariyla degil, OLCUMLE tutuluyor:
    ...
    test_00.py    veri_00.kur(0) ile veri_okul4.kur(0) DERIN
...
# ======================================================================
# model_00'IN VERISI — iki adim + PARMAK IZI
# ======================================================================
...
def kur(tohum=0):
    """model_00'in grafi: 1x taban + sekiz alan acilimi."""
    ...
    if tohum == 0:
        ...
        assert _iz == IZ, (
            ...
            "  degisiklik geri alinir. model_00 sessizce baska bir\n"
            "  veriyle KOSMAZ.")
    return G
