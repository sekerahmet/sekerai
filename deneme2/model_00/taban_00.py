# -*- coding: utf-8 -*-
"""taban_00 — model_00'in KENDI motoru. TEK BASINA DURUR.
...
Bu dosya `model_a.py`nin KOPYASIDIR ve artik model_00'a aittir.
...
KENDILIGINDEN gelmez; model_00 ile model_b15 O GUNDEN SONRA FARKLI
KODLA olculmus olur. Bu, kopyanin gercek riski ve gozden kacarsa
sayilari sessizce karsilastirilamaz hale getirir.

Bunun icin `test_00.py` her kosuda DAVRANIS ESDEGERLIGI siniyor:

    egitim havuzu       taban_00 vs model_a  -> BIT DUZEYINDE ayni
...
# import ediyordu. `taban_00` bunu YAPMIYOR: model_00'in verisi
# `veri_00.py`, ve o BU klasorde. Veri modulu `veri_kur` icinde
...
class Ayar:
    ...
    veri_ad: str = "veri_00"     # HANGI GRAF. "veri_okul2" = tam IKI KATI.
...
# kosulabiliyordu. `taban_00` bir MOTOR; model_00'in ayari `ayar_00.py`de,
# kosuyu baslatan `model_00.py`. Burada calistirilacak bir sey YOK.
