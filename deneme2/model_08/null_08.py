...
`kayip_tabani_08.py` KAYBIN tabanini veriyor (kosullu entropi). Burasi
...
def null(kol: str = "08", yaz=print, v=None):
    """`v` verilirse veri YENIDEN KURULMAZ -- `test_08` boyle cagiriyor."""
